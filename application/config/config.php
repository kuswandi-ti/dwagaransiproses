...
$config['PATH_ASSET_CUSTOM_SCRIPTS'] 			= 'assets/custom_scripts/';
$config['PATH_ASSET_IMAGE']			 			= 'assets/img/';
...
$config['FORMAT_TIME_TO_INSERT'] 				= 'H:i:s';

/* CONNECTION DATABASE */
$config['CONN_NAME_DWASYS']						= 'conn_dwasys';
$config['CONN_NAME_DWAFINACCT']					= 'conn_dwafinacct';
